    ...
    <div className="app-layout">
      <aside className="sidebar">
        ...
        <nav>
          ...
          <NavLink to="/app/onboarding"><Settings size={18} /> {t('layout.setup')}</NavLink>
          ...
          <NavLink to="/app/staff"><Users size={18} /> {t('layout.staff')}</NavLink>
        </nav>
        <div style={{ marginTop: '2rem', paddingTop: '1rem', borderTop: '1px solid var(--border)' }}>
          <LanguageSwitcher />
          <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '0.75rem' }}>{user?.email}</p>
